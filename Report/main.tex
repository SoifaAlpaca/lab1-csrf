...
\usepackage{anysize} % Personalize margin
...
\usepackage{fancyhdr} % Head note and footnote
    ...
    \fancyhead[R]{\footnotesize Radio Frequency Circuits and Systems} % Right of Head note
...
\begin{center}
    ...
    \textsc{\LARGE Radio Frequency Circuits and Systems}\\[2.0cm]
    \HRule\\[0.4cm]
    {\large \bf {Communication Link Simulation in GNU-Radio \\Testing of a Low-IF receiver (SDR)}}\\[0.2cm]
    \HRule\\[1.5cm]
\end{center}
...
%\subfile{Sections/GNURadio.tex}
\subfile{Sections/AMComunication.tex}
\subfile{Sections/DigitalModulation.tex}
\subfile{Sections/Spice.tex}
\subfile{Sections/VNA.tex}
\subfile{Sections/RFFE.tex}
...
\appendix
\section{Appendix A: Python Scripts, GNURadio and Qucs-s files}

The python scripts, GNURadio flowgraphs, and Qucs-s files used throughout this report are available in the GitHub repository: \url{https://github.com/MartimAgostinho/ERF-Lab2.git}
