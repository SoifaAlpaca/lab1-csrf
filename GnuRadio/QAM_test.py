...
class QAM_test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "QAM tests", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("QAM tests")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "QAM_test")
        ...
        self.low_pass_filter_1_0_1 = filter.interp_fir_filter_fff(
            1,
            firdes.low_pass(
                1,
                samp_rate,
        ...
        self.low_pass_filter_1_0_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.low_pass_filter_1_0 = filter.interp_fir_filter_fff(
            1,
            firdes.low_pass(
                1,
                samp_rate,
        ...
        self.blocks_file_sink_0_0_0_0 = blocks.file_sink(gr.sizeof_float*1, '/Users/martim/Uni/MEEC/SM3/CSRF/Lab/lab1-csrf/GnuRadio/FileOutput/Q_symb_in.data', False)
        self.blocks_file_sink_0_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0_0 = blocks.file_sink(gr.sizeof_float*1, '/Users/martim/Uni/MEEC/SM3/CSRF/Lab/lab1-csrf/GnuRadio/FileOutput/I_symb_in.data', False)
        self.blocks_file_sink_0_0_0.set_unbuffered(False)
        self.blocks_file_sink_0_0 = blocks.file_sink(gr.sizeof_float*1, '/Users/martim/Uni/MEEC/SM3/CSRF/Lab/lab1-csrf/GnuRadio/FileOutput/Q_16_qam.data', False)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.low_pass_filter_1_0_0, 0))
        ...
        self.connect((self.blocks_file_source_0_0, 0), (self.blocks_file_sink_0_0_0_0, 0))
        self.connect((self.blocks_file_source_0_0, 0), (self.low_pass_filter_1_0_1, 0))
        self.connect((self.blocks_file_source_0_0, 0), (self.qtgui_time_sink_x_1, 2))
        ...
        self.connect((self.low_pass_filter_1_0_1, 0), (self.qtgui_time_sink_x_1, 3))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_1_0_1.set_taps(firdes.low_pass(1, self.samp_rate, self.Sig_band, self.filter_transition, window.WIN_HAMMING, 6.76))
    ...
    def get_Sig_band(self):
        return self.Sig_band

    def set_Sig_band(self, Sig_band):
    ...
    def get_Base_Band(self):
        return self.Base_Band
...
def main(top_block_cls=QAM_test, options=None):
