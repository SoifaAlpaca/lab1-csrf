...
class Lab0(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._variable_channel_atenuation_range = qtgui.Range(1, 100, 1, 1, 200)
        ...
        self._receiver_power_amplifier_a1_range = qtgui.Range(-20, 20, 0.5, -1, 200)
        ...
        self._noise_amplitude_range = qtgui.Range(0, 0.2, 0.005, 0, 200)
        self._noise_amplitude_win = qtgui.RangeWidget(self._noise_amplitude_range, self.set_noise_amplitude, "Maximum noise amplitude", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._emitter_cutoff_LP_range = qtgui.Range(100, 80000, 10, 40000, 200)
        ...
        self.blocks_multiply_const_vxx_1_1 = blocks.multiply_const_ff(emitter_power_amplifier_a2)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 20000, 3, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_0, 0), (self.low_pass_filter_1_0, 0))
        ...
        self.connect((self.blocks_add_xx_1_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
    ...
    def set_emitter_power_amplifier_a2(self, emitter_power_amplifier_a2):
        ...
        self.blocks_multiply_const_vxx_1_1.set_k(self.emitter_power_amplifier_a2)
